...
//evento input ativa toda vez que houver alteração no input
...
const copyInstructions = document.querySelector("#generated-rule > p")
...
rulesArea. addEventListener("click", (e) => {
  ...
  setTimeout(()=>copyInstructions.innerText = "Cloque no quadro acima para copiar as regras!", 2000)
